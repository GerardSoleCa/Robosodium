...
public class VerifyKey {
    ...
    public boolean verify(byte[] message, byte[] signature) throws SignatureException {
        ...
        if (sodium().crypto_sign_ed25519_open(buffer, bufferLen, sigAndMsg, sigAndMsg.length, key) != 0)
            throw new SignatureException();
        return true;
    }

    public boolean verify(String message, String signature, Encoder encoder) throws SignatureException {
    ...
    public class SignatureException extends Exception{
        ...
        public String getMessage() {
            return "Signature was forged or corrupted. "+super.getMessage();
        }
    }
}
